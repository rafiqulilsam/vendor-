...
@section('content')
    <div class="container bg-dark text-light">
        <button class=" col-md-11 btn btn-block btn-dark"> <a href="{{ route('admin.purchase.index') }}">purchase Show</a>
        </button>
        <div class="row col-md-12 bg-dark text-light">
            <label for="" class="col-md-12">
                <h2 class="btn-block text-center"> purchase Create</h2>

                <form class="col-md-12 text-light" method="POST" action="{{ route('admin.purchase.store') }}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <button type="submit" class="col-sm-12" class="btn bg-primary ">create purchase</button>
                        </div>
                    </div>
